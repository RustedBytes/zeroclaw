...
WORKDIR /app
# Keep the container runtime-capable without re-enabling TUI or Prometheus.
ARG ZEROCLAW_CARGO_FEATURES="agent-runtime,gateway,schema-export,channel-telegram"
